        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              thumbColor={darkMode ? '#37ab30' : '#f4f3f4'}
            />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              trackColor={{ false: '#e5e5e5', true: '#37ab30' }}
              thumbColor={notifications.all ? '#37ab30' : '#f4f3f4'}
            />
          </View>
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              trackColor={{ false: '#e5e5e5', true: '#37ab30' }}
              thumbColor={notifications.push ? '#37ab30' : '#f4f3f4'}
            />
          </View>
          <View style={styles.settingRow}>
            ...
            <Switch
              ...
              trackColor={{ false: '#e5e5e5', true: '#37ab30' }}
              thumbColor={notifications.email ? '#37ab30' : '#f4f3f4'}
            />
          </View>
        </View>
