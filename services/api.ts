...
const UK_BUSES: TransportRoute[] = [
  ...
  {
    id: 'bus-london-1',
    title: 'Route 390 - Kings Cross → Victoria',
    description: 'Direct city bus service',
    type: 'bus',
    status: 'Active',
    image: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=400&h=300&fit=crop',
    duration: '25min',
    origin: 'Kings Cross Station',
    destination: 'Victoria Coach Station',
    price: '£2.50',
  ...
  {
    id: 'bus-london-2',
    title: 'Route 73 - Victoria → Paddington',
    description: 'Cross-London service',
    type: 'bus',
    status: 'Active',
    ...
    price: '£2.50',
    schedule: ['06:15', '06:45', '07:15', '07:45', '08:15', '08:45'],
    rating: 4.4,
    reviews: 198,
  },
  {
    id: 'bus-london-3',
    title: 'Route 205 - Paddington → Kings Cross',
...
const UK_TRAINS: TransportRoute[] = [
  // London Underground/Inner City trains
  {
    id: 'train-london-1',
    title: 'Victoria Line - Kings Cross → Victoria',
    description: 'London Underground direct service',
    type: 'train',
    status: 'Active',
    ...
    price: '£2.80',
    schedule: ['06:00', '06:15', '06:30', '06:45', '07:00', '07:15'],
    rating: 4.6,
    reviews: 523,
  },
  {
    id: 'train-london-2',
    title: 'Circle Line - Victoria → Paddington',
    description: 'London Underground circular route',
    type: 'train',
    status: 'Active',
    image: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=400&h=300&fit=crop',
    duration: '20min',
    ...
    destination: 'Paddington Station',
    price: '£2.80',
    schedule: ['06:10', '06:25', '06:40', '06:55', '07:10', '07:25'],
    rating: 4.5,
    reviews: 412,
  },
  {
    id: 'train-london-3',
    title: 'Metropolitan Line - Kings Cross → Liverpool Street',
    description: 'Fast underground connection',
    type: 'train',
    status: 'Active',
    ...
    price: '£2.80',
    schedule: ['06:00', '06:20', '06:40', '07:00', '07:20', '07:40'],
    rating: 4.7,
    reviews: 634,
  },
  {
...
const UK_DESTINATIONS: TransportRoute[] = [
  {
    ...
    description: 'Iconic clock tower and Westminster Palace',
    type: 'destination',
    status: 'Popular',
  ...
  },
  {
    id: 'dest-2',
    title: 'Tower Bridge',
    description: 'Victorian Gothic combined bascule and suspension bridge',
    type: 'destination',
    status: 'Popular',
